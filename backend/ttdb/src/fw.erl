...
-export([customer_add/1, device_add/2, package_add/3]).
...
%% Auxiliary function for adding package to device's package set
...
%% Auxiliary function for retrieving the bucket set where device's releases are kept
